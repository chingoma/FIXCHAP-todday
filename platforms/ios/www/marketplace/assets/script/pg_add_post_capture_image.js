function capture_image(data){
    if(data.length == 1){
        ...
        $(".camera-img").before('<div class="col-3 to_d"  style="padding: 2px;" id="img_'+image_index+random_number+'"><div class="img-uploading-loader" id="loader_count_'+img_upload_count+'"></div> <img class="item_photo" style="width: 90px; height: 90px; object-fit: cover;" onclick="pre_remove_image('+image_index+',\'img_'+image_index+random_number+'\')"  src="data:image/jpeg;base64,'+data+'"></div>');
