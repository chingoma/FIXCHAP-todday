$(document).ready(function() {
    ...
    $(document).on({
        'DOMNodeInserted': function() {
            $('.pac-item, .pac-item span, .login_element', this).addClass('needsclick');
        }
    }, '.pac-container');
    ...
    setTimeout(function() {
        ...
        var swiper_single = new Swiper('.single-item', {
            autoplay: 3000
        });
        var swiper_text = new Swiper('.text-slider', {
            autoplay: 3000
        });
        ...
        var swiper_coverpage = new Swiper('.coverpage-slider', {
            autoplay: 3000
        });
...
function display_mynot(message, type){ 
    if(type == 1){
        $("#warning1-icon").html('<i class="fa fa-check"></i>');
    } else {
        $("#warning1-icon").html('<i class="fa fa-warning"></i>');
    }
    $("#warning1-msg").html(message);
