...
function capture_image(datar){

    let data = reduce_image_file_size(datar)
    ...
    if(data.length == 1){
        ...
        $(".camera-img").before('' +
            ...
            '<img class="item_photo" style="width: 90px; height: 90px; object-fit: cover;" onclick="pre_remove_image('+image_index+',\'img_'+image_index+random_number+'\')"  src="data:image/jpeg;base64,' + datar + '"></div>');
