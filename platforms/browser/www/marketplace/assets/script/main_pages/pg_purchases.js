function purchases_sold(refresh=true){
    ...
    $('#go_to_purchases-completed').addClass('sub-menu-active');
    ...
    if(refresh){
        item_storage_loading('purchases');      
    } 

    item_storage('purchases',true);
